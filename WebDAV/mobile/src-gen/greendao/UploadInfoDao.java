...
public class UploadInfoDao extends AbstractDao<UploadInfo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property AutoSyncUpload = new Property(8, Boolean.class, "autoSyncUpload", false, "AUTO_SYNC_UPLOAD");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'UPLOAD_INFO' (" + //
                ...
                "'AUTO_SYNC_UPLOAD' INTEGER," + // 8: autoSyncUpload
    ...
    protected void bindValues(SQLiteStatement stmt, UploadInfo entity) {
        ...
        Boolean autoSyncUpload = entity.getAutoSyncUpload();
        if (autoSyncUpload != null) {
            stmt.bindLong(9, autoSyncUpload ? 1l: 0l);
        }
    ...
    public UploadInfo readEntity(Cursor cursor, int offset) {
        UploadInfo entity = new UploadInfo( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0, // autoSyncUpload
    ...
    public void readEntity(Cursor cursor, UploadInfo entity, int offset) {
        ...
        entity.setAutoSyncUpload(cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0);
